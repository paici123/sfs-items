...
<div class="container main-content">
    ...
    <div class="post-content">
      <form action="{$siteurl}/comment.php" method="post">
        <table class="table table-striped">
          <tr>
            <td class="w20">留言标题</td>
            <td><input class="form-control" type="text" name="msgtitle" value="我对贵公司产品感兴趣"/></td>
          </tr>
          <tr>
            <td class="w20">您的姓名</td>
            <td><input class="form-control" type="text" name="msgname"/></td>
          </tr>
          <tr>
            <td class="w20">联系方式</td>
            <td><input class="form-control" type="text" name="msgcontact"/></td>
          </tr>
          <tr>
            <td class="w20">联系邮箱</td>
            <td><input class="form-control" type="text" name="msgcmail"/></td>
          </tr>
          <tr>
            <td class="w20">留言内容</td>
            <td><textarea class="form-control" name="msgcontent" rows="10" cols="30"></textarea></td>
          </tr>
          <tr>
            <td class="w20">验证码</td>
            <td><input class="form-control" type="text" name="capcode" style="width:80px;"/>
              &nbsp;<img style="cursor:pointer" src="{$siteurl}/captcha/captcha.php" onclick="$(this).attr('src','{$siteurl}/captcha/captcha.php?d='+Date())" /></td>
          </tr>
          <tr>
            <td class="w20">&nbsp;</td>
            <td><input type="hidden" name="action" value="save"/>
              <input class="btn btn-lg" type="submit" value="提交" /></td>
          </tr>
        </table>
      </form>
    </div>
  ...
  <div class="col-sm-4 sidebar row">
    <div class="widget">
      ...
      <div class="content community"> {assign var="productcat" value=$categorydata->GetCategoryList(0,'product',0,'')}
