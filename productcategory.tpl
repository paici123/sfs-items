...
<div class="container main-content">
  <div class="post col-sm-8 row">
    ...
    <div class="post-content article-list"> {if ($total > 0)}
      ...
      <div class="col-sm-4 col-md-3 col-xs-6 product-box"> <a href="{formaturl type="product" siteurl=$siteurl name=$productinfo->filename}" target="_blank">
